...
import vtkMprWidget from '@/src/vtk/MprWidget';
import { useViewConfigStore } from '../view-configs';
import { useView2DStore } from '../views-2D';

export const useMprToolStore = defineStore('mpr', () => {
  type _This = ReturnType<typeof useMprToolStore>;

  const factory = vtkMprWidget.newInstance();
